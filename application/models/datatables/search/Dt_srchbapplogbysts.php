<?php
	...
	class Dt_srchbapplogbysts extends CI_Model 
	{
		var $table = 'trx_bapplog a';
		var $column_order = array(null,'balg_code','balg_date','cust_name','loc_name');
		var $column_search = array('balg_code','balg_date','cust_name','loc_name');
		var $order = array('a.balg_id' => 'desc');
