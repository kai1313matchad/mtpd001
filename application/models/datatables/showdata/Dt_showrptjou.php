<?php
	...
	class Dt_showrptjou extends CI_Model 
	{

		var $table = 'jou_details a';
		var $column_order = array(null,'jou_code','jou_date','jou_reff','jou_info','coa_acc','joudet_debit','joudet_credit');
		var $column_search = array('jou_code','jou_date','jou_reff','jou_info','coa_acc','joudet_debit','joudet_credit');
