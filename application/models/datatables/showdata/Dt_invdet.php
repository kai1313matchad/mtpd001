<?php
	...
	class Dt_invdet extends CI_Model 
	{

		var $table = 'inv_details a';
		var $column_order = array(null,'appr_code','loc_name','appr_po','invdet_term','invdet_amount');
		var $column_search = array('appr_code','loc_name','appr_po','invdet_term','invdet_amount');
		var $order = array('invdet_id' => 'desc');
