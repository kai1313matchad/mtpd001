            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2 text-center" style="padding-bottom: 15px" >
                        <a href="<?php echo base_url(); ?>administrator/Logistik/lap_po"><button id="filter" type="button" name="input"  class="btn btn-primary col-sm-12"><span style="color: white" class="glyphicon glyphicon-refresh"></span> Reset</button></a>
                    </div>
                </div>
