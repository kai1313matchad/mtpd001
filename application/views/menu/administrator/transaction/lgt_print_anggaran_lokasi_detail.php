<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cetak Laporan Anggaran Per Lokasi</h1>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" id="printArea">
                    ...
                    <div class="text-center">
                        <h3><strong><u>LAPORAN Anggaran Per Lokasi Detail</u></strong></h3>
