<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cetak Laporan Anggaran Per Proyek Summary</h1>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" id="printArea">
                    ...
                    <div class="text-center">
                        <h3><strong><u>LAPORAN Anggaran Per Proyek Summary</u></strong></h3>
                                        ...
                                        <table id="tb_gm" class="table table-condensed">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="col-sm-4 col-xs-4">Lokasi</th>
    ...
    <script>
        ...
        function printPre()
        {
            ...
            window.open ( "<?php echo site_url('administrator/Transaction/pageprint_anggaran_proyek_summary/')?>"+seg1+'/'+seg2,'_blank');
        }
            ...
            $.ajax({
                ...
                {                    
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        rtotal = data[i]["BUDDET_SUM"] * data[i]["BUDDET_AMOUNT"];
                        atotal = atotal + rtotal;
                        ctotal = ctotal + rtotal;
                        total = total + rtotal;
                        var n=0;
                        if ((approval != data[i]["BUD_APPR"]) && (approval != "")){
                            var $tr = $('<tr>').append(
                    ...
                    var $tr = $('<tr>').append(
                                      ...
                                      $('<td>').text(data[n]["LOC_CODE"]+' + '+data[n]["LOC_ADDRESS"]),
                                      $('<td>').css({'text-align':'right'}).text(formatCurrency(atotal,".",",",2))   
                                    ).appendTo('#tb_content');
                    var $tc = $('<tr>').append(
                                         $('<td>').text(''),
                    ...
                    var $tot = $('<tr>').append(
                                      $('<td>').text(''),
                                      $('<td colspan="3">').css({'font-weight':'bold','text-align':'right'}).text('Grand Total'), 
