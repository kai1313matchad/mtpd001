<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cetak Laporan Anggaran Per Lokasi Summary</h1>
                    </div>
                </div>
                <div class="row">
    ...
    <script>
        ...
        function printPre()
        {
            ...
            window.open ( "<?php echo site_url('administrator/Transaction/pageprint_anggaran_lokasi_summary/')?>"+seg1+'/'+seg2,'_blank');
        }
