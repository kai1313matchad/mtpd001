...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12 table-responsive">
                <table id="dtb_master_usr" class="table table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th>Username</th>
                            <th>Nama</th>
    ...
    <script>
        ...
        {
            $.ajax({
                url : "<?php echo site_url('administrator/Master/get_masteruser')?>",
                type: "GET",
                dataType: "JSON",
