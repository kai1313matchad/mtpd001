<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cetak Laporan Faktur Pajak Per Nomor</h1>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" id="printArea">
                    ...
                    <div class="text-center">
                        <h3><strong><u>LAPORAN Faktur Pajak Per Nomor</u></strong></h3>
            ...
            $.ajax({
                ...
                {                    
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        var rtotal = data[i]["TINVDET_SUB"];
                        totaldpp = totaldpp + rtotal;
                        totappn = totalppn + rtotal;
                        total = total + totaldpp + totalppn;
                        var $rc = $('<tr>').append(
