<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cetak Giro Keluar</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form id="form_printgm" method="post" action="#" class="form-horizontal">
                            <div class="form-group">                              
                                <label class="col-sm-3 control-label">Nomor GK</label>
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" name="gm_code" readonly>
                                    <input type="hidden" name="gk_id">
                                    <!-- <input type="hidden" name="cust_id"> -->
                                </div>
                                <div class="col-sm-1">
                                    <a href="javascript:void(0)" onclick="srch_gk()" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-search"></span> Cari</a>
                                </div>
                            </div>
                        </form>
                    </div>
