<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cetak Laporan Faktur Pajak Per Nomor Summary</h1>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" id="printArea">
                    ...
                    <div class="text-center">
                        <h3><strong><u>LAPORAN Faktur Pajak Per Nomor Summary</u></strong></h3>
                                        ...
                                        <table id="tb_gm" class="table table-condensed">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="col-sm-2 col-xs-2">Nomor Invoice</th>
    ...
    <script>
        ...
        function printPre()
        {
            ...
            window.open ( "<?php echo site_url('administrator/Finance/pageprint_FP_nomor_summary/')?>"+seg1+'/'+seg2,'_blank');
        }
                ...
                {                    
                    ...
                    if (jml > 1) {
                        var $ta = $('<tr>').append(
                                  ...
                                  $('<td>').text(''), 
                                  $('<td>').text(''), 
                                  $('<td>').css({'border-top':'2px solid','font-weight':'bold','text-align':'right','border-bottom':'double'}).text(formatCurrency(totaldpp,".",",",2)),  
                                  $('<td>').css({'border-top':'2px solid','font-weight':'bold','text-align':'right','border-bottom':'double'}).text(formatCurrency(totalppn,".",",",2)),
                                  $('<td>').css({'border-top':'2px solid','font-weight':'bold','text-align':'right','border-bottom':'double'}).text(formatCurrency(total,".",",",2)) 
                                 ).appendTo('#tb_content');
                    }
                    var $ta = $('<tr>').append(
                              $('<td>').text(''),
                              ...
                              $('<td>').text(''),
                              $('<td>').text(''), 
                              $('<td>').css('text-align','right').text('GRAND TOTAL'), 
                              $('<td>').css({'border-top':'2px solid','font-weight':'bold','text-align':'right'}).text(formatCurrency(gtotaldpp,".",",",2)),  
                              $('<td>').css({'border-top':'2px solid','font-weight':'bold','text-align':'right'}).text(formatCurrency(gtotalppn,".",",",2)),
                              $('<td>').css({'border-top':'2px solid','font-weight':'bold','text-align':'right'}).text(formatCurrency(gtotal,".",",",2)) 
                                     ).appendTo('#tb_content');
                },
                error: function (jqXHR, textStatus, errorThrown)
                {
