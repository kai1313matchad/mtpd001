<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cetak Kas Masuk</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        <form id="form_printkm" method="post" action="#" class="form-horizontal">
                            <div class="form-group">                              
                                <label class="col-sm-3 control-label">Nomor KM</label>
                                <div class="col-sm-4">
                                    <input class="form-control" type="text" name="km_code" readonly>
                                ...
                                <div class="col-sm-1">
                                    <a href="javascript:void(0)" onclick="srch_km()" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-search"></span> Cari</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <!-- Modal Search -->
    <div class="modal fade" id="modal_km" name="modal_km" role="dialog">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 table-responsive">
                            <table id="dtb_km" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>No</th>
    ...
    <script>
        ...
        {            
            $('#modal_km').modal('show');
            $('.modal-title').text('Cari Kas Masuk'); // Set title to Bootstrap modal title      
            //datatables        
            table = $('#dtb_km').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('administrator/Finance/ajax_srch_km')?>",
                    "type": "POST",                
                },
