<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cetak Laporan Giro Per Tanggal Terima</h1>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" id="printArea">
                    ...
                    <div class="text-center">
                        <h3><strong><u>LAPORAN Giro Per Tanggal Terima</u></strong></h3>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <table id="tb_gm" class="table table-condensed">
                                            <thead>
                                                <tr>
                                                    <th class="col-sm-2 col-xs-2">Tgl. Terima</th>
    ...
    <script>
        ...
        {            
            ...
            $.ajax({
                url : "<?php echo site_url('administrator/Finance/show_giro_tgl_terima/')?>/",
                type: "POST",
                ...
                {                    
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (tgl != data[i]["RECEIVE_DATE"]){
                            ...
                            var $tr = $('<tr>').append(
                                      $('<td>').text(formattanggal(data[i]["RECEIVE_DATE"]))
                                      ).appendTo('#tb_content');
                            tgl=data[i]["RECEIVE_DATE"];
                            tdebet = 0;
                            tkredit = 0;
                            total = 0;
                        }
