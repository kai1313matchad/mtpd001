<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Finance - Laporan Bank</h1>
                    </div>
                </div>
                <div class="row">
                    <form class="form-horizontal" id="form_rptbank" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input class="form-control" type="text" name="rptbank_branch" readonly>
                                <input type="hidden" name="rptbank_branchid">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class='input-group date dtp' id='dtp1'>
                                    ...
                                    <input id="rptbank_datestart" type='text' class="form-control input-group-addon" name="rptbank_datestart" value="" />
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class='input-group date dtp' id='dtp1'>
                                    ...
                                    <input id="rptbank_dateend" type='text' class="form-control input-group-addon" name="rptbank_dateend" value="" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input class="form-control" type="text" name="rptbank_coa" readonly>
                                <input type="hidden" name="rptbank_coaid">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <label class="radio-inline">
                                    <input type="radio" name="group" value="1"> Buku Bank
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="group" value="2"> Bank Harian
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-offset-3 col-sm-2">
                                <a href="javascript:void(0)" onclick="show_rptbank()" class="btn btn-block btn-info">
    ...
    <script>
        ...
        // }
        function show_rptbank()
        {
            var n = checkradio();
            if(n == 1)
            {
                var seg1 = $('[name="rptbank_coaid"]').val()?$('[name="rptbank_coaid"]').val():'null';
                var seg2 = $('[name="rptbank_datestart"]').val()?$('[name="rptbank_datestart"]').val():'null';
                var seg3 = $('[name="rptbank_dateend"]').val()?$('[name="rptbank_dateend"]').val():'null';
                var seg4 = $('[name="rptbank_branchid"]').val()?$('[name="rptbank_branchid"]').val():'null';
                var seg5 = n;
                window.open ( "<?php echo site_url('administrator/Finance/print_rptbank/')?>"+seg1+'/'+seg2+'/'+seg3+'/'+seg4+'/'+seg5,'_blank');
            }
            else if(n == 2)
            {
                var m = $('[name="rptbank_coaid"]').val();
                if(m != '')
                {
                    var seg1 = $('[name="rptbank_coaid"]').val()?$('[name="rptbank_coaid"]').val():'null';
                    var seg2 = $('[name="rptbank_datestart"]').val()?$('[name="rptbank_datestart"]').val():'null';
                    ...
                    var seg4 = $('[name="rptbank_branchid"]').val()?$('[name="rptbank_branchid"]').val():'null';
                    var seg5 = n;
                    window.open ( "<?php echo site_url('administrator/Finance/print_rptdbank/')?>"+seg1+'/'+seg2+'/'+seg3+'/'+seg4+'/'+seg5,'_blank');
                }
                else
                {
    ...
    <script>
        function pick_branch(id)
        {
            $.ajax({
                ...
                {   
                    $('[name="rptbank_branchid"]').val(data.BRANCH_ID);
                    $('[name="rptbank_branch"]').val(data.BRANCH_NAME);
        ...
        function pick_coagb(id)
        {
            $.ajax({
                ...
                success: function(data)
                {   
                    $('[name="rptbank_coaid"]').val(data.COA_ID);
                    $('[name="rptbank_coa"]').val(data.COA_ACC+' - '+data.COA_ACCNAME);
