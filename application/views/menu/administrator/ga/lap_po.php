<!-- Page Content -->
                ...
                <div class="row">
                    <div class="col-sm-4 col-md-offset-3 text-center" style="padding-bottom: 15px" >
                     ...
                     <div class="col-sm-2 text-center" style="padding-bottom: 15px" >
                        <a href="<?php echo base_url(); ?>administrator/Genaff/lap_po"><button id="filter" type="button" name="input"  class="btn btn-primary col-sm-12"><span style="color: white" class="glyphicon glyphicon-refresh"></span> Reset</button></a>
                    </div>
                </div>
    ...
    function ambildata(){
        table = $('#dtb_po').DataTable({
            ...
            "ajax": {
                "url": "<?php echo base_url('administrator/Genaff/ajax_filter_po')?>",
                "type": "POST",      
                "data": function(data){
                    data.supp = $('[name="isi"]').val();
    ...
    function ayo(){
        ...
        $("#dtb_po td:nth-child(6)").css({'display':'none'});
        $("#dtb_po td:nth-child(6)").css({'display':'none'});
    }
    </script>
    ...
    <script type="text/javascript">
        function pick_po(id)
        {
            window.open ( "<?php echo site_url('administrator/Genaff/pageprint_po/')?>"+id,'_blank');
        }
    </script>
</body>
</html>