                ...
                {                       
                    for (var i = 0; i < data.length; i++) {
                      var $tr = $('<tr>').append(
                            ...
                            $('<td>').css('text-align','center').text(data[i]["PGDET_QTYUNIT"]+' '+data[i]["GD_MEASURE"]),                            
                    ...
                    var $tr = $('<tr>').append(
                            ...
                            $('<td class="text-right chgnum" style="border-top:2px solid; font-weight: bold;">'+data[0]["POGA_GTOTAL"]+'</td>')
                            ).appendTo('#tb_content');
