<!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Dashboard Report GA</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                   <!--  <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="<?php echo base_url('administrator/Genaff/lap_po')?>">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="<?php echo base_url('administrator/Genaff/lap_pembelian')?>">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="<?php echo base_url('administrator/Genaff/lap_retpembelian')?>">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
