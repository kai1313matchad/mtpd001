                    ...
                    <ul class="nav iki" id="side-menu">                        
                        ...
                        <li <?php if ($menu == 'master') {echo 'class=active';} ?>>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a <?php if ($menulist == 'bank') {echo 'class=active';} ?> href="<?php echo base_url('administrator/Master/bank')?>"><i class="fa <?php if ($menulist == 'bank') {echo 'fa-circle';} else {echo 'fa-circle-o';}?> fa-fw"></i> Barang</a>
                                </li>
                                <li>
